        ...
        <td valign="top">
            <div class="content">
                <div class="conthead">
                    ...
                    <a href="<?= core::$home ?>/assistance?lotid=<?= $id ?>" class="button"  style="float: right; margin-top: -25px;" target="_blank">
                        Помощь в торгах
                    </a>
                    <a href="<?= core::$home ?>/zayavka?dann&id=<?= $id ?>" class="button" style="float: right; margin-top: -25px; margin-right: 10px;" target="_blank">
                        Оформить заявку для Орг.Торг
                    </a>
                    <a href="<?= core::$home ?>/request?lotid=<?= $id ?>" class="button" style="float: right; margin-top: -25px; margin-right: 10px;" target="_blank">
                        Заказать ЭЦП/КЦП 
                    </a>
                </div>
